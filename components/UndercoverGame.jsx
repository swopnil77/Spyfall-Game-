...
const CATEGORIES = {
  ...
  sportsStars: { label: "Sports Stars", icon: "🏅", items: ["Cristiano Ronaldo","Lionel Messi","Virat Kohli","Serena Williams","LeBron James","Neymar","Usain Bolt","Roger Federer","Kylian Mbappé","Novak Djokovic","Sachin Tendulkar","Michael Jordan","Rafael Nadal","Tom Brady","Simone Biles","Mike Tyson","Kobe Bryant","Muhammad Ali","Michael Phelps","MS Dhoni","Neeraj Chopra","David Beckham","Shane Warne"] },
